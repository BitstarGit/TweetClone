...
$cl["app_statics"] = array(
	"styles" => array(
		cl_static_file_path("statics/css/apps/search/style.master.css"),
		cl_static_file_path("statics/css/apps/search/style.mq.css"),
		cl_static_file_path("statics/css/apps/search/style.custom.css")
	)
);
