...
if (empty($cl["users_list"])) {
	...
	$cl["app_statics"] = array(
		"styles" => array(
			cl_static_file_path("statics/css/apps/followers/style.master.css"),
			cl_static_file_path("statics/css/apps/followers/style.mq.css"),
			cl_static_file_path("statics/css/apps/followers/style.custom.css")
		)
	);
