...
$update_stat  = false;
$new_sql      = array(
	"CREATE TABLE `cl_verifications` ( `id` INT(11) NOT NULL AUTO_INCREMENT,  `user_id` INT(11) NOT NULL DEFAULT '0',  `full_name` VARCHAR(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',  `text_message` VARCHAR(1200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',  `video_message` VARCHAR(300) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',  `status` ENUM('pending','rejected') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'pending',  `time` INT(25) NOT NULL DEFAULT '0', PRIMARY KEY  (`id`)) ENGINE = InnoDB CHARSET=utf8 COLLATE utf8_general_ci;",
	"ALTER TABLE `cl_users` ADD `verified` ENUM('0','1') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' AFTER `active`;",
			...
			<?php if ($update == true && $update_stat == false): ?>
				...
				<ol>
					<li>
						...
						<span class="change-log-li">[Fixed] Previous several minor bugs</span>
					</li>
					<li>
						<span class="badge feature">Feature</span> 
						<span class="change-log-li">[Added] User verification system</span>
					</li>
					<li>
						<span class="badge feature">Feature</span> 
						<span class="change-log-li">[Added] Registration confirmation system</span>
					</li>
					<li>
						<span class="badge feature">Feature</span> 
						<span class="change-log-li">[Added] User ban by admin system</span>
					</li>
					<li>
						<span class="badge feature">Feature</span> 
						<span class="change-log-li">[Added] User privacy system</span>
					</li>
					<li>
						<span class="badge feature">Feature</span> 
						<span class="change-log-li">[Added] Welcome page for guests</span>
					</li>
					<li>
						<span class="badge feature">Feature</span> 
						<span class="change-log-li">[Added] Media files (Images, Videos) lazy loading system</span>
					</li>
					<li>
						<span class="badge feature">Feature</span> 
						<span class="change-log-li">[Added] Sitemap creation system</span>
					</li>
				</ol>
